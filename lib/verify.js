...
module.exports = async (pluginConfig, { logger }) => {
  ...
  if (pluginConfig.uploadSourceMaps === undefined) {
    pluginConfig.uploadSourceMaps = true;
  }

  logger.log(`Sentry config, packageName: ${packageName}, uploadSourceMaps: ${pluginConfig.uploadSourceMaps}`);
